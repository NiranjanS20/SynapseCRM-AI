      ...
      >
        ...
        <Card className="border-white/10 shadow-2xl bg-white/5 backdrop-blur-xl">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardDescription>Join SynapseCRM and build your intelligent workspace</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <Button variant="outline" className="w-full h-11 border-white/10 hover:bg-white/5" onClick={handleGoogleSignup} disabled={loading}>
              ...
              <Button variant="outline" className="w-full h-11 border-white/10 hover:bg-white/5" onClick={handleMicrosoftSignup} disabled={loading}>
          ...
          <CardFooter className="flex flex-col gap-4">
            <div className="text-sm text-center text-slate-500">
              Already have an account? <Link href="/login" className="text-sage-400 hover:text-sage-300 transition-colors">Log in</Link>
            </div>
          </CardFooter>
        </Card>
      </motion.div>
